...
echo "Création des fichiers de configuration LXC"
#Fichier lxc-net
...
echo "Mise en place de apache et haproxy"
#web1
...
#Iptables
echo "Création des règles iptables"
...
#Ssh
echo "Génération de la clef ssh"
...
echo "Paramétrer l'ip des conteneurs sur haproxy"
echo "Ajouter site1 et site2 sur WinServer"
